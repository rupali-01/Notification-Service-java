...
public class KafkaConsConfig {
    ...
    @Bean
    public ConsumerFactory<String, String> consFactory() {
        return new DefaultKafkaConsumerFactory<>(consconfig());
    }
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, String>> factory(ConsumerFactory<String, String> consFactory)
    {
